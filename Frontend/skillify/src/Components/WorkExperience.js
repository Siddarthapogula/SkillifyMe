...
return (
  <div name='work' className='px-4  md:h-screen text-gray-300 bg-[#0a192f]'>
    <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
      <span className='text-4xl font-bold inline'>
        <span className='border-b-4 border-pink-600 my-20'>Work Experience</span> </span>
      {jobExperience.map((job, index) => (
        <div key={index} className="rounded-lg shadow-2xl p-6 my-[3rem] mb-8">
