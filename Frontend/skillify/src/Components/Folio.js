...
const Folio = () => {
  ...
  async function handleCreateFolio() {
    ...
    try {
      await axios.post(`${BACKEND_BASE_URL}/folio/create`, folioBody, headers);
    } catch (e) {
      alert(e?.message);
    }
    setSelectedRole("");
    ...
    if (isOkay) {
      ...
      const newWorkExperience = {
        ...
        jobDuration:
          ...
          " - " +
          (endDate.current?.value === "" ? "present" : endDate.current?.value),
          ...
          <div className=" flex justify-center  ">
            <div className="flex justify-center   w-10/12 h-[30%] ">
              ...
              <form className="  w-[70%] bg-[#2A3467]  opacity-70 py-[2rem] border-b-[1px] border-white">
                ...
                <input
                  ref={userName}
                  className="  bg-gray-200 w-[95%] font-[350] mb-2 text-lg px-3  py-[0.3rem] rounded-sm"
                />
                {/* address */}
                <div className=" text-white font-[400] text-lg">
                  Where are you based? *
                ...
                >
                  <option value="" disabled className=" text-lg">
                    {" "}
                    select your
                    roleㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ
                    ▼
                  </option>
                  {roles.map((role) => (
                    <option
                      className=" bg-[#a3aacc] text-lg   text-white  m-[1rem] hover:bg-[#354fa5]"
                      key={role}
                      value={role}
                    >
                      {role}
          ...
          <div className=" flex justify-center ">
            <div className="flex justify-center  w-10/12 h-[30%]">
              ...
              <form className="  w-[70%] bg-[#2A3467]  opacity-70 py-[2rem] border-b-[1px] border-white">
                ...
                <input
                  ref={linkedinLink}
                  className="  bg-gray-200 w-[95%] mb-2  font-[350] text-lg px-3  py-[0.3rem] rounded-sm"
                />
                <div className=" text-white font-[400] text-lg">
                  {" "}
          ...
          <div className=" flex justify-center ">
            <div className="flex justify-center  w-10/12 h-[30%]">
              ...
              <form
                ...
                className="  w-[70%] bg-[#2A3467]  opacity-70 py-[2rem] border-b-[1px] border-white"
              >
                ...
                <input
                  ref={endDate}
                  placeholder="e.g-dec-2023(skip, if you are currently working in this company)"
                  className="  bg-gray-200 w-[95%] mb-2 font-[350] text-lg px-3  py-[0.3rem] rounded-sm"
                />
                ...
                <textarea
                  ...
                  className=" bg-gray-200 mb-2 w-[95%] font-[350] text-lg p-2 pb-[8.5rem] rounded-sm resize-none overflow-y-auto max-h-[400px]"
                ...
                <div>
                  ...
                  {selectedTechnologies.length > 0 && (
                    <div className=" mb-5">
                      <div className=" text-white font-[400] text-base">
                        Used Technologies :{" "}
                      </div>
                      {selectedTechnologies.map((tech) => (
                        <span
                          key={tech}
                          className=" text-white font-[200] text-base"
                        >
                          {tech}ㅤ
                        </span>
                      ))}
                ...
                {isNull && (
                  <p className=" w-[40%] my-2 text-lg text-white bg-gradient-to-r from-black to-[#2A3467] rounded-sm ">
                    Please enter the essential fields
                  </p>
                )}
                <button
                  className=" px-2 p-[0.3rem] bg-[#0000FF] text-white rounded-sm "
                  onClick={() => {
                    handleAddNewExperience();
                  }}
                >
                  {isOkay ? "Add Another Experience*" : "Ok*"}
                </button>
              </form>
            </div>
          </div>
          ...
          <div className=" flex justify-center ">
            <div className="flex justify-center  w-10/12 h-[30%]">
              ...
              >
                ...
                <input
                  ref={projectName}
                  className="  bg-gray-200 pb-2 w-[95%] font-[350] text-lg px-3  py-[0.3rem] rounded-sm"
                />
                <div className=" text-white   font-[400] text-lg">
                  projectLink*
                </div>
                ...
                <div>
                  ...
                  {techStack.length > 0 && (
                    <div>
                      <div className=" pb-2 text-white font-[400] text-base">
                        Used Technologies :{" "}
                      </div>
                      {techStack.map((tech) => (
                        <span
                ...
                <button
                  className="my-2 px-2 p-[0.3rem] bg-[#0000FF] text-white rounded-sm "
                  onClick={() => {
                    handleAddNewProject();
                  }}
                >
                  {isProjectOk ? "Add Another Project*" : "Ok*"}
                </button>
              </form>
            </div>
          </div>
          ...
          <div className=" flex justify-center ">
            <div className="flex justify-center  w-10/12 h-[30%]">
              ...
              <form className="  w-[70%] bg-[#2A3467]  opacity-70 py-[2rem] border-b-[1px] border-white">
                ...
                <textarea
                  ref={services}
                  className=" bg-gray-200 w-[95%] font-[350] text-lg p-2 pb-[0.5rem] rounded-sm resize-none overflow-y-auto max-h-[200px]"
                  placeholder="Enter your services here, like web development, content writer..."
                />

                <div className=" py-2 text-white font-[400] text-lg">
                  Your skills *
                </div>
                <select
                  value={techStack}
                ...
                {skillSet.length > 0 && (
                  <div className=" py-4">
                    <div className="py-4 pb-2 text-white font-[400] text-base">
                      Skills Selected :{" "}
                    </div>
                    {skillSet.map((tech) => (
                      <span
                ...
                <input
                  ref={resumeDriveLink}
                  className="  bg-gray-200 w-[95%] pb-2 font-[350] text-lg px-3  py-[0.3rem] rounded-sm"
                />
                <div className=" text-white   font-[400]  text-lg">
                  Your bio*
                </div>
                <textarea
                  ref={bio}
                  className=" bg-gray-200 w-[95%] font-[350] text-lg p-2 pb-[8.5rem] rounded-sm resize-none overflow-y-auto max-h-[200px]"
            ...
            <div className="flex justify-center pb-2 w-10/12 h-[30%] ">
              <div className=" w-[30%]  bg-[#2A3467] opacity-70">
                <div className=" pl-3 pt-3">
                  ...
                  <div className=" text-white ">
                    {" "}
                    Provide your essential contact information to help others
              ...
              <form className="  w-[70%] bg-[#2A3467]  opacity-70 py-[2rem] border-b-[1px] border-white">
                ...
                <input
                  ref={phoneNo}
                  className="  bg-gray-200 w-[95%] font-[350] text-lg px-3  py-[0.3rem] rounded-sm"
                />
                <div className=" text-white font-[400] text-lg">
                  Your email*
                </div>
                ...
                <button
                  ...
                  className=" px-4 my-4 py-2 text-white rounded-md ml-[10rem] bg-[#0000FF] items-center"
                >
